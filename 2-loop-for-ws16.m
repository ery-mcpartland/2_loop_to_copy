...
(* ::Input::Initialization:: *)
Canvas[Graphics[{}, AspectRatio -> 0.2161547212741752, DefaultBaseStyle -> {"CanvasGraphics"}, ImageSize -> {879, 190}, PlotRange -> {{-1., 1.}, {-1., 1.}}, PlotRangePadding -> {{0.04166666666666674, 0.04166666666666674}, {0.040000000000000036`, 0.040000000000000036`}}],Background->Pane[($CellContext`traceamp["cquark", $CellContext`e3, Pattern[$CellContext`a, Blank[]]] := Simplify[X`Spur[$CellContext`opqq[$CellContext`a], Dot[X`DiracG, $CellContext`l] + $CellContext`mc X`Dirac1, X`LTensor[X`DiracG, $CellContext`\[Mu]], Dot[X`DiracG, $CellContext`l + $CellContext`q] + $CellContext`mc X`Dirac1, X`LTensor[X`DiracG, $CellContext`\[Nu]1], Dot[X`DiracG, $CellContext`l + $CellContext`q + $CellContext`r] + $CellContext`mc X`Dirac1, X`LTensor[X`DiracG, $CellContext`\[Nu]1], Dot[X`DiracG, $CellContext`l + $CellContext`q] + $CellContext`mc X`Dirac1] $CellContext`CreateAmplitude[$CellContext`CFe[$CellContext`a] $CellContext`Qc X`DiracMatrix[$CellContext`opbs[$CellContext`a]], $CellContext`P1^2 $CellContext`P2 $CellContext`P4 $CellContext`P12]]; Null) ($CellContext`traceamp["masslessquark", $CellContext`e3, Pattern[$CellContext`a, Blank[]]] := Simplify[X`Spur[$CellContext`opqq[$CellContext`a], Dot[X`DiracG, $CellContext`l], X`LTensor[X`DiracG, $CellContext`\[Mu]], Dot[X`DiracG, $CellContext`l + $CellContext`q], X`LTensor[X`DiracG, $CellContext`\[Nu]1], Dot[X`DiracG, $CellContext`l + $CellContext`q + $CellContext`r], X`LTensor[X`DiracG, $CellContext`\[Nu]1], Dot[X`DiracG, $CellContext`l + $CellContext`q]] $CellContext`CreateAmplitude[$CellContext`CFe[$CellContext`a] $CellContext`Qc X`DiracMatrix[$CellContext`opbs[$CellContext`a]], $CellContext`P1hat^2 $CellContext`P2hat $CellContext`P4 $CellContext`P12hat]]; Null) ($CellContext`traceamp["bquark", $CellContext`e3, Pattern[$CellContext`a, Blank[]]] := Simplify[X`Spur[$CellContext`opqq[$CellContext`a], Dot[X`DiracG, $CellContext`l] + $CellContext`mb X`Dirac1, X`LTensor[X`DiracG, $CellContext`\[Mu]], Dot[X`DiracG, $CellContext`l + $CellContext`q] + $CellContext`mb X`Dirac1, X`LTensor[X`DiracG, $CellContext`\[Nu]1], Dot[X`DiracG, $CellContext`l + $CellContext`q + $CellContext`r] + $CellContext`mb X`Dirac1, X`LTensor[X`DiracG, $CellContext`\[Nu]1], Dot[X`DiracG, $CellContext`l + $CellContext`q] + $CellContext`mb X`Dirac1] $CellContext`CreateAmplitude[$CellContext`CFe[$CellContext`a] $CellContext`Qc X`DiracMatrix[$CellContext`opbs[$CellContext`a]], $CellContext`P1mb^2 $CellContext`P2mb $CellContext`P4 $CellContext`P12mb]]; Null), BoxID -> "ForCanvasToggle", BaselinePosition -> Baseline, ImageSize -> {879, 190}, ImageSizeAction -> "ShrinkToFit"]]
